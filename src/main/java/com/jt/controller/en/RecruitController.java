...
@Controller("ENRecruitController")
public class RecruitController {
	...
	//-- recruit / 인재상
	@GetMapping(value="/"+SiteFolder+"/recruit/talent")
	...
	//-- recruit / 직무소개
	@GetMapping(value="/"+SiteFolder+"/recruit/recruitIntroduce")
	...
	@GetMapping(value="/"+SiteFolder+"/recruit/recruitCulture")
	...
	//-- recruit / 채용공고
	@GetMapping(value="/"+SiteFolder+"/recruit/recruit")
	...
	//-- recruit / 채용공고 상세보기
	@GetMapping(value="/"+SiteFolder+"/recruit/recruitView")
	public ModelAndView recruitView(int code) throws Throwable {
		...
		//-- recruit / 인재풀등록
		@GetMapping(value="/"+SiteFolder+"/recruit/recruitResources")
		...
		//-- recruit / 입사지원
		@GetMapping(value="/"+SiteFolder+"/recruit/application")
		...
		//-- recruit / 입사지원 메일보내기
		@PostMapping(value = "/"+SiteFolder+"/recruit/MailSend")
