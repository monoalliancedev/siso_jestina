...
public class IRController {
	...
	//IR : 주가정보 ///ir/infor1
	@GetMapping(value="/"+SiteFolder+"/ir/infor1")
	public String infor1() {
		return "/"+SiteFolder+"/ir/infor1";
	}
	//IR : 공시정보 ///ir/infor2
	@GetMapping(value="/"+SiteFolder+"/ir/infor2")
	public String infor2() {
		return "/"+SiteFolder+"/ir/infor2";
	}

	//IR : 공고 //notice
	@RequestMapping(value="/"+SiteFolder+"/ir/notice" , method = {RequestMethod.GET, RequestMethod.POST})
	...
	//IR : 공고 상세보기
	@PostMapping(value="/"+SiteFolder+"/ir/noticeView")
