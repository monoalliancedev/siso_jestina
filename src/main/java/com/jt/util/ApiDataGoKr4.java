...
public class ApiDataGoKr4 {

	//신주인수권증서시세
	//public static void main(String[] args) throws IOException {
	public ApiDataGoKr4() throws UnsupportedEncodingException, IOException {	
		StringBuilder urlBuilder = new StringBuilder("https://api.odcloud.kr/api/GetStockSecuritiesInfoService/v1/getPreemptiveRightCertificatePriceInfo"); /*URL*/
        ...
        for(int i=0; i < itemList.length(); i++) { 
			System.out.println("======== 신주인수권증서시세 list : " + i + " ========"); 
			...
			System.out.println("종가 * 상장증서수 <mrktTotAmt> : " + listObject.get("mrktTotAmt")); //
			System.out.println("신주인수권증서의 상장증서수 <lstgCtfCnt> : " + listObject.get("lstgCtfCnt")); //
			System.out.println("신주인수권증서의 신주발행가 <nstIssPrc> : " + listObject.get("nstIssPrc")); //
			System.out.println("신주인수권증서의 상장폐지일 <dltDt> : " + listObject.get("dltDt")); //
			System.out.println("신주인수권증서의 목적주권 종목코드 <purRgtScrtItmsCd> : " + listObject.get("purRgtScrtItmsCd")); //
			System.out.println("신주인수권증서의 목적주권 종목명 <purRgtScrtItmsNm> : " + listObject.get("purRgtScrtItmsNm")); //
			System.out.println("신주인수권증서의 목적주권 종가 <purRgtScrtItmsClpr> : " + listObject.get("purRgtScrtItmsClpr")); //
			System.out.println(); //
			System.out.println(); //
			System.out.println(); //
			System.out.println(); //
