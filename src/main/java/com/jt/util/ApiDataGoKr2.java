...
public class ApiDataGoKr2 {

	//수익증권시세 2
	//public static void main(String[] args) throws IOException {
	public ApiDataGoKr2() throws UnsupportedEncodingException, IOException {
		
		//getStockPriceInfo (주식시세)
		StringBuilder urlBuilder = new StringBuilder("https://api.odcloud.kr/api/GetStockSecuritiesInfoService/v1/getSecuritiesPriceInfo"); /*URL*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("basDt","UTF-8") + "=" + URLEncoder.encode("20220126", "UTF-8")); 
        ...
        for(int i=0; i < itemList.length(); i++) { 
			System.out.println("======== 수익증권시세 list : " + i + " ========"); 
			...
			System.out.println("현선물 통합상품의 종목 코드(12자리) <isinCd> : " + listObject.getString("isinCd")); //현선물 통합상품의 
			...
			System.out.println("수익증권의 상장좌수 <stLstgCnt> : " + listObject.get("stLstgCnt")); //
			System.out.println("종가 * 상장주식수 <mrktTotAmt> : " + listObject.get("mrktTotAmt")); //
