                                ...
                                <div class="fileField">
                                    ...
                                    <div class="addFile">
                                        ...
                                        <c:when test="${banner.fileViewName[0] ne '' and banner.fileViewName[0] ne null}">
	                                        ...
	                                        <span class="size" id="SignSize0${arrGubun[status.count-1]}">(<i>${banner.fileViewSize[0]}</i>byte)</span>
                                ...
                                <div class="fileField">
                                    ...
                                    <div class="addFile">
                                        ...
                                        <c:when test="${banner.fileViewName[1] ne '' and banner.fileViewName[1] ne null}">
	                                        ...
	                                        <span class="size" id="SignSize1${arrGubun[status.count-1]}">(<i>${banner.fileViewSize[1]}</i>byte)</span>
