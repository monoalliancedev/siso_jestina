...
function Jt_submit(key) { 
	...
	newText = headerDeleteHtml($("#ir"+key).val());
	if(newText.length<=0) {
		alert( " 내용을 입력해주세요.");
		return;
	}	
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="url">
                                ...
                                <div class="forPC"><input type="text" name="linkKr" value="${banner.linkKr}" class="enterText" placeholder="PC 링크주소 URL을 입력해주세요."/></div>
                                <div class="forMobile"><input type="text" name="molinkKr" value="${banner.molinkKr}" class="enterText" placeholder="Mobile 링크주소 URL을 입력해주세요."/></div>
                            </td>
                        </tr>
                        <tr>
