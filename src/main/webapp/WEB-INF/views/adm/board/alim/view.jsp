	...
	$.ajax({ //게시여부Y가 2개 이상인지 확인
        ...
        success : function(data){
			...
			if(isntYnKey) {
				...
				alert("공지사항 게시글은 1개 이상 등록되어야 합니다.");
			} 
		}
    });
    return false;
...
<input type="hidden" name="total_rows" value="${search.total_rows}" />
		...
		<div id="container" class="bbsMgmt noticeReg">
		    <!--상단-->
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="fileField">
                        			...
                        			<input type="file" name="uploadFile" multiple="multiple" class="action"/>
                                    <div class="addFile">
                                        <c:choose>
                         ...
                         -->
                        <tr>
                            <th>첨부파일<br/><span class="s_text">(워드,엑셀,PPT,PDF 파일만 첨부 가능)</span></th>
