    ...
    function autoDateButton() {
        ...
        $('.autoDateBtn a.oneWeek').click(function () {
            if (oneWeekCount.getDate() <= 9 && oneWeekCount.getMonth() + 1 > 9) {
                ...
                $(this).parents('.autoDateBtn').prev('.termDate').find('.endDate input.end').val(oneWeekCount.getFullYear() + '-' + '0' + (oneWeekCount.getMonth()+1) + '-' + oneWeekCount.getDate())
            } else {
        ...
        $('.autoDateBtn a.oneMonth').click(function () {
            if (oneMonthCount.getDate() <= 9 && oneMonthCount.getMonth() + 1 > 9) {
                ...
                $(this).parents('.autoDateBtn').prev('.termDate').find('.endDate input.end').val(oneMonthCount.getFullYear() + '-' + '0' + (oneMonthCount.getMonth() + 1) + '-' + oneMonthCount.getDate())
            } else {
        ...
        $('.autoDateBtn a.twoMonths').click(function () {
            if (twoMonthCount.getDate() <= 9 && twoMonthCount.getMonth() + 1 > 9) {
                ...
                $(this).parents('.autoDateBtn').prev('.termDate').find('.endDate input.end').val(twoMonthCount.getFullYear() + '-' + '0' + (twoMonthCount.getMonth() + 1) + '-' + twoMonthCount.getDate())
            } else {
